package processing.test.nomenklatur_basic;
...
public class Nomenklatur_Basic extends PApplet {
...
//buttons
int t1 = color(121, 149, 255);
int f1 = color(121, 149, 255);
int f2 = color(121, 149, 255);
int f3 = color(121, 149, 255);
int t1to = t1;
int t1from = t1;
int f1to = f1;
int f1from = f1;
...
public void typeName(int mode, int C) {
  if (defaultLanguage == 0) {
...
//Alkane
public void drawAlkane(int n, int x1, float y1, float dx, float y2) {
  if (mode == 0) {
    if (C >= 2) {
      for (; n < C - 1; n = n + 1) {
        strokeJoin(ROUND);
...
public void drawAlkene(int n, int positionAlkene, int x1, float y1, float dx, float y2) {
  if (mode == 1) {
...
public void drawAlkine(int n, int positionAlkine, int x1, float y1, float dx, float y2) {
  if (mode == 2) {
...
public void drawAldehyde(int n, int positionAldehyde, int x1, float y1, float dx, float y2) {
  if (mode == 3) {
    if ( C > 1) {
      for (; n < C - 1; n = n + 1) {
        strokeJoin(ROUND);
...
public void drawAcid(int n, int positionCarboxylicGroup, int x1, float y1, float dx, float y2) {
  if (mode == 4) {
    if (C > 1) {
      for (; n < C - 1; n = n + 1) {
        strokeJoin(ROUND);
...
public void drawAlcohol(int n, int positionAlcohol, int x1, float y1, float dx, float y2) {
  if (mode == 5) {
...
//stop
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Nomenklatur_Basic" };
    if (passedArgs != null) {
